...
package com.test.vibhujavaservice;
...
//import com.test.vibhujavaservice.model.*;
 ...
 */
@ExposeToClient
public class VIbhuJavaService {

    private static final Logger logger = LoggerFactory.getLogger(VIbhuJavaService.class);
