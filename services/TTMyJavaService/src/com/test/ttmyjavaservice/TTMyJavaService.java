...
package com.test.ttmyjavaservice;
...
//import com.test.ttmyjavaservice.model.*;
 ...
 */
@ExposeToClient
public class TTMyJavaService {

    private static final Logger logger = LoggerFactory.getLogger(TTMyJavaService.class);
