...
import com.test.highscoredb.Table11;
import com.test.highscoredb.service.Table11Service;
...
public class Table11Controller {
    ...
    public Page<Table11> findTable11s(@RequestParam(value = "q", required = false) @ApiParam(value = "conditions to filter the results") String query, @ApiParam(value = "") Pageable pageable) {
    ...
    public Table11 createTable11(@RequestBody @ApiParam(value = "") Table11 table11) {
    ...
    public Table11 getByColumn4AndColumn3(@RequestParam(value = "null", required = true) @ApiParam(value = "") String column4, @RequestParam(value = "null", required = true) @ApiParam(value = "") String column3) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Returns the matching Table11 with given unique key values.")
    public Table11 getByColumn4(@PathVariable("column4") @ApiParam(value = "") String column4) {
    ...
    public Downloadable exportTable11s(@PathVariable("exportType") @ApiParam(value = "") ExportType exportType, @RequestParam(value = "q", required = false) @ApiParam(value = "conditions to filter the results") String query, @ApiParam(value = "") Pageable pageable) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Returns the list of Table11 instances matching the search criteria.")
    public Page<Table11> findTable11s(@ApiParam(value = "") Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table11s list");
    ...
    public Table11 getTable11(@PathVariable("id") @ApiParam(value = "") Integer id) throws EntityNotFoundException {
    ...
    public Table11 editTable11(@PathVariable("id") @ApiParam(value = "") Integer id, @RequestBody @ApiParam(value = "") Table11 table11) throws EntityNotFoundException {
    ...
    public boolean deleteTable11(@PathVariable("id") @ApiParam(value = "") Integer id) throws EntityNotFoundException {
